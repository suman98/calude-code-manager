...
export const api = {
  ...
  // Reveals VS Code's own integrated terminal (not an external Terminal.app
  // window). Always opens — closing stays with Ctrl+J / the panel's X.
  showVscodeTerminal: () =>
    invoke<void>("send_vscode_command", { command: "showTerminal", sessionId: null }),
